  ...
  return (
    <header className="relative pt-32 pb-48 md:pb-64 bg-[#4a6c48]" id="get-app">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        {/* Subtitle */}
        <p className="mt-4 max-w-2xl mx-auto text-xl text-green-50 font-light leading-relaxed">
          Decode labels instantly. From ingredient quality to environmental
          impact, GudForUs gives you the clarity to make better choices for your
          body and the planet.
        </p>
        ...
        <div className="mt-10 max-w-3xl mx-auto">
          ...
          {/* Stats */}
          <div className="mt-8 flex justify-center gap-6 text-sm text-green-100 flex-wrap">
